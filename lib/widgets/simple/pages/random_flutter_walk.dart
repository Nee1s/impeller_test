...
class RandomFlutterWalk extends StatelessWidget {
  const RandomFlutterWalk({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text('Flutter Random Walk'),
        ),
        body: Child(
          ...
          builder: (child) => Animator<Offset>(
            ...
            statusListener: (status, animatorState) {
              ...
              if (status == AnimationStatus.completed) {
                ...
                endX = endX > screenSize.width - 50 ? screenSize.width - 50 : endX;
                endX = endX < 0 ? 0 : endX;
                endY = endY > screenSize.height - 50 ? screenSize.width - 50 : endY;
                endY = endY < 0 ? 0 : endY;
                ...
                animatorState
                  ..resetAnimation(
                    ...
                    curve: beginY != 0 || beginY != 0 ? Curves.easeInOut : Curves.bounceIn,
