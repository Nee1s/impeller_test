          ...
          Expanded(
            child: AnimateWidget(
              ...
              builder: (context, animate) {
                final padding = animate.setCurve(const Interval(0.250, 0.375, curve: Curves.ease)).call(
                      selected ? const EdgeInsets.only(bottom: 16.0) : const EdgeInsets.only(bottom: 75.0),
                    );
                final opacity = animate.setCurve(const Interval(0.0, 0.100, curve: Curves.ease)).call(
                      selected ? 0.5 : 1.0,
                    )!;
                ...
                final color = animate.setCurve(const Interval(0.500, 0.750, curve: Curves.ease)).call(
                      selected ? Colors.indigo[100] : Colors.orange[400],
                    );
                final borderRadius = animate.setCurve(const Interval(0.375, 0.500, curve: Curves.ease)).call(
                      selected ? BorderRadius.circular(4.0) : BorderRadius.circular(75.0),
                    );
                return Center(
                  child: Container(
                    width: 300.0,
